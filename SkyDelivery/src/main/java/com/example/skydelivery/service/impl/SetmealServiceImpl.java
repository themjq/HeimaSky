...
import com.example.skydelivery.entity.SetmealDish;
import com.example.skydelivery.exception.DeletionNotAllowedException;
import com.example.skydelivery.exception.SetmealEnableFailedException;
...
import com.example.skydelivery.service.SetmealService;
...
public class SetmealServiceImpl implements SetmealService {
    ...
    public SetmealVO getByIdWithDish(Long id) {
        Setmeal setmeal = setmealMapper.getMealById(id);    //获得套餐信息
        List<SetmealDish> setmealDishes=setmealDishMapper.getDishsBymealId(id);//获取套餐内的详细信息
